view: period {
  derived_table: {
    sql: select period_key, period_level, school_year, report_school_year, period_start_date, sort_seq from stars.period where district_key='35000999' and marking_period is not null;;
  }
