view: area_assmt_dlm_ela_math_science {
  sql_table_name: CEDSDW.AREA_Assmt_DLM_ELA_Math_Science ;;
  ...
  dimension: pl_d {
    ...
    description: "Proficiency level: 1=Emerging, 2=Approaching Target, 3=At Target, 4=Advanced"
    sql: ${TABLE}.PL ;;
  }
  measure: pl {
    type: average
  ...
  dimension: subtest {
    type: string
    description: "Subtest name: LA (Language Arts), Math, Science"
    sql: ${TABLE}.Subtest ;;
  }
  dimension: test {
    type: string
    description: "Name of the test (DLM)"
    sql: ${TABLE}.Test ;;
  }
