view: area_assmt_nmmssa_ela {
  sql_table_name: CEDSDW.AREA_Assmt_NMMSSA_ELA ;;
  ...
  dimension: ssread_d {
    type: string
    label: "Scale Score - Reading"
    description: "Reading scale score: 300-890"
    sql: ${TABLE}.SSRead ;;
  }
  dimension: sswrite_d {
    type: string
    label: "Scale Score - Writing"
    description: "Writing scale score: 300-890"
    sql: ${TABLE}.SSWrite ;;
  }
  measure: ss {
    type: average
    label: "Scale Score"
    description: "Scale Score: 300-890"
    sql: cast(${TABLE}.SS as numeric) ;;
  }
  measure: ssread {
    type: average
    label: "Scale Score - Reading"
    description: "Reading scale score: 300-890"
    sql: cast(${TABLE}.SSRead as numeric) ;;
  }
  measure: sswrite {
    type: average
    label: "Scale Score - Writing"
    description: "Writing scale score: 300-890"
    sql: cast(${TABLE}.SSWrite as numeric) ;;
  }
